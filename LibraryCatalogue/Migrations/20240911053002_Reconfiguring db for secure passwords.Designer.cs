...
namespace LibraryCatalogue.Solution.Migrations
{
    ...
    [Migration("20240911053002_Reconfiguring db for secure passwords")]
    partial class Reconfiguringdbforsecurepasswords
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryCatalogue.Models.AccountType", b =>
                {
            ...
            modelBuilder.Entity("LibraryCatalogue.Models.LibraryUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("LibraryCatalogue.Models.AuthorBook", b =>
                {
                    ...
                    b.HasOne("LibraryCatalogue.Models.Book", "Book")
                        .WithMany("AuthorBooks")
            ...
            modelBuilder.Entity("LibraryCatalogue.Models.Checkout", b =>
                {
                    ...
                    b.HasOne("LibraryCatalogue.Models.LibraryUser", "User")
                        .WithMany("Checkouts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LibraryCatalogue.Models.LibraryUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
